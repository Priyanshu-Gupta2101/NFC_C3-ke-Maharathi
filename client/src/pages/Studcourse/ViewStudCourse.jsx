    ...
    const getdata = async () => {
      try {
        const res = await axios.get(
          `https://wealthwise-server-nuyhus6uf-priyanshu-gupta2101.vercel.app/api/v1/getSingleCourse/${id}`
        );
        if (res?.status === 200) {
              ...
              <div className="mt-6">
                ...
                <div className="grid grid-cols-1 gap-4 mt-4 w-full">
                  ...
                  {selectedVideo && (
                    <div className="mt-4">
                      <video
                        src={`https://wealthwise-server-nuyhus6uf-priyanshu-gupta2101.vercel.app/uploads/${selectedVideo.filename}`}
                        controls
                      ></video>
                      <button
